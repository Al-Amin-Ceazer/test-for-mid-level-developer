...
<body>
    <div class="content">
        <h1 class="m-b-md" style="font-size: 40px">Don't panic...</h1>
        <small><code class="red">Output will be in respective routes, with blood color.</code></small><br/>
        <br/>1. Some people bought some items from Daraz, which was recorded in some table of your database.
        Defined as: <code>`buyers`</code>, <code>`diary_taken`</code>, <code>`eraser_taken`</code> and <code>`pen_taken`</code>.
        <br/><b>You have to create migration from the following table instructed.</b>
        Please find the information where -
        ...
        <br/>&emsp;&emsp;6c. Which Question did you solve without any help of other source? (Like any guy or internet)
        <br/><br/>
        <br/><br/>
